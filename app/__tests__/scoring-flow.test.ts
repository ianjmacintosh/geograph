...
describe('Scoring Flow Validation', () => {
  ...
  describe('Multi-Player Game', () => {
    it('should calculate correct placement-based scoring', () => {
      ...
      const comp1Total = comp1Result.placementPoints + calculateBonusPoints(250) // 2 + 2 = 4
      const comp2Total = comp2Result.placementPoints + calculateBonusPoints(800) // 1 + 1 = 2
  ...
  describe('Score Display Logic', () => {
    ...
    it('should create complete guess objects with all required fields', () => {
      ...
      const placements = calculatePlacementPoints([{ playerId: testGuess.playerId, distance: testGuess.distance }], 1)

...
describe.skip("Flickering Detection Test - Refactored", () => {
  ...
  it("should handle multiple players scoring calculation", () => {
    ...
    expect(sortedGuesses[0].totalPoints).toBeGreaterThan(
      sortedGuesses[1].totalPoints,
    );
    expect(sortedGuesses[1].totalPoints).toBeGreaterThan(
      sortedGuesses[2].totalPoints,
    );
  });
});
